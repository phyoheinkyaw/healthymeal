...
$stmt = $mysqli->prepare("SELECT * FROM categories ORDER BY created_at DESC");
$stmt->execute();
            ...
            <div class="container-fluid">
                <div class="row mb-4">
                    <div class="col-12 d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-primary btn-ripple" data-bs-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-ripple" onclick="saveCategory()">Save
                        Category</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="editCategoryModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary btn-ripple" onclick="updateCategory()">Update
                        Category</button>
                </div>
            </div>
        </div>
